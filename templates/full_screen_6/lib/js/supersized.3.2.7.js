    ...
    jQuery.supersized = function(options){
		...
		base.nextSlide = function(){
		    ...
		    var nextslide = jQuery(base.el+' li:eq('+vars.current_slide+')'),
		    	prevslide = base.jQueryel.find('.prevslide');
	    	...
	    	switch(base.options.transition){
	    		...
	    		case 2: case 'slideTop':	// Slide Top
	    		    nextslide.css({top : -base.jQueryel.height(), 'visibility': 'visible'}).animate({ top:0, avoidTransforms : false }, base.options.transition_speed, function(){ base.afterAnimation(); });
	    		    break;
	    		case 3: case 'slideRight':	// Slide Right
	    			nextslide.css({left : base.jQueryel.width(), 'visibility': 'visible'}).animate({ left:0, avoidTransforms : false }, base.options.transition_speed, function(){ base.afterAnimation(); });
	    			break;
		...
		base.prevSlide = function(){
		    ...
		    switch(base.options.transition){
	    		...
	    		case 6: case 'carouselRight':	// Carousel Right (reverse)
	    			nextslide.css({left : -base.jQueryel.width(), 'visibility': 'visible'}).animate({ left:0, avoidTransforms : false }, base.options.transition_speed, function(){ base.afterAnimation(); });
					liveslide.css({left : 0}).animate({ left: base.jQueryel.width(), avoidTransforms : false}, base.options.transition_speed );
	    			break;
