	...
	public function getMarkers() 
	{
		if ((int)$this->item->useajaxobject == 0)
		{
			...
			{       
				...
				{
                                    $placemarklistid = explode(',', str_replace(';',',', $placemarklistid));                                       
                                    $placemarklistid = ArrayHelper::toInteger($placemarklistid);
                                    $placemarklistid = implode(',', $placemarklistid);                        

                                    $addWhereClause .= ' and h.id IN ('.$placemarklistid.')';
				}
	...
	public function getMarkerGroups() 
	{
		...
		{       
			...
			else
			{
                                ...
                                if (strpos($placemarklistid, ','))
                                {
                                        $addWhereClause .= ' and m.id IN ('.$placemarklistid.')';
                                }
                                else
                                {
                                        $addWhereClause .= ' and m.id = '.(int)$placemarklistid;
                                }                            				
			}
