...
form.getElements('div.ccomment-actions.hide').toggleClass('hide');if(typeof this.config.captcha_pub_key!=='undefined'){Recaptcha.create(this.config.captcha_pub_key,el.getParent('form').getElement('.ccomment-recaptcha-placeholder'),{theme:"white"});}
...
self.closeForm(el);counter=self.collection.info.countParents.toInt()+1;}}
