...
class plgContentLightGallery extends JPlugin
{
	...
	private function generateGallery( $params, $options ) {
		...
		{
			$galleryText .= "<a href=\"".$v."\" data-lightbox=\"".$OptionArray['galleryName']."\" data-title=\"".$options[2]."\">"."<img src=\"".$v."\" style=\"vertical-align: top; margin: ".$margin."; width: ".$OptionArray['previewWidth']."px; height: ".$OptionArray['previewHeight']."px;\">"."</a>";
		}
		return $galleryText;
	}
}
