    ...
    */
	...
	function addPopUp($idx) {
		...
		if (strlen($this->popupwidth) > 0) {
			...
			$spu_boxwidth = $this->params->get( 'spu_boxwidth', '420' );
		}
		...
		if ($this->popupvideo !== 'true') {
			...
			echo '	<div id="spucontent'.$this->popupname.'" class="'.$this->popupcssclass.'" style="text-align: '.$spu_aligntext.'; margin-top: 20px;">', chr(10);
